    ...
    <ul>
      <div v-for="(item,index) in list" :key="item.product_id">
        ...
        <li v-show="index<showLength">
            ...
            <router-link :to="{ path: 'goods/details', query: {productID:item.product_id} }" @click="routerRefresh">
...
.myList ul li img {
  ...
  width: 160px;
  height: 160px;
  background: url(../../../../44/mistore/src/assets/imgs/placeholder.png) no-repeat 50%;
  margin: 0 auto;
}
.myList ul li h2 {
  margin: 25px 10px 0;
